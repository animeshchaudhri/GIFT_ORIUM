...
export const metadata = {
  ...
  description:
    "Discover unique and thoughtful gifts for all occasions at Gift Orium. Shop premium gifts, flowers, soft toys, religious items, and more with fast delivery across India.",
  keywords: [
    "gifts",
    "online gift shop",
    "premium gifts",
  ...
  openGraph: {
    ...
    description:
      "Discover unique and thoughtful gifts for all occasions at Gift Orium. Shop premium gifts, flowers, soft toys, religious items, and more.",
    siteName: "Gift Orium",
    images: [
      {
        url: "/landing.jpg",
    ...
    <html lang="en" suppressHydrationWarning itemScope itemType="http://schema.org/WebSite">
      <head>
        ...
        <script
          ...
          data-website-id="2b7026fb-2c9e-4071-8d00-894dde457488"
        ></script>
      </head>
