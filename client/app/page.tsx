  ...
  const deals = [
    {
      name: "Perfume Set",
      imageSrc:
        "https://images.unsplash.com/photo-1585386959984-a4155224a1b1?auto=format&fit=crop&w=400&q=80",
      discount: "-20%",
    },
    {
      name: "Gold Watch",
    ...
    },
    {
      ...
      imageSrc:
        "https://images.unsplash.com/photo-1611599531556-92f4b10f882b?auto=format&fit=crop&w=400&q=80",
      discount: "-25%",
    },
    {
      name: "Gift Box",
    ...
    },
    {
      name: "Beauty Kit",
      imageSrc:
        "https://images.unsplash.com/photo-1600180758890-6f12f6611f8a?auto=format&fit=crop&w=400&q=80",
      discount: "-10%",
    },
  ];
  ...
  const blogPosts = [
    {
      ...
      summary:
        "Discover our collection of the cutest soft toys that bring comfort and joy to anyone's life.",
    ...
    },
    {
      ...
      summary:
        "Artificial flowers are becoming a popular trend in home decor for their beauty and longevity.",
    ...
    },
    {
      ...
      summary:
        "Explore our curated collection of religious items, bringing blessings and serenity into your home.",
      ...
      <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  What Makes Us Unique In Our Values
                </h2>
                <p className="text-gray-600 mb-6">
                  We believe in providing exceptional gift experiences that
        ...
        <section className="bg-amber-100 py-12">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button
              asChild
              className="bg-pink-500 hover:bg-pink-600 text-white rounded-full px-8 py-2"
            >
      ...
      {deals.map((item, index) => (
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl font-bold mb-4">
                We Provide Best And Quality Gifts For You
              </h2>
              <p className="text-gray-600 mb-6">
                Our team of gift experts carefully curates each collection to
                ensure you find the perfect gift for every occasion.
              </p>
        ...
        <section className="bg-pink-50 py-12">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold mb-8 text-center">
              We Provide Premium Quality Gift For You
            </h2>
              ...
              {[
                {
                  ...
                  desc: "Handpicked gifts for every occasion",
                },
                {
                  title: "Fast Delivery",
                  desc: "Get your gifts on time, every time",
                },
                {
                  title: "Gift Wrapping",
                  desc: "Beautiful presentation for your special gifts",
                },
              ].map((item, index) => (
                <div
                  key={index}
